...
def pre_sconscript(stm_out, sconscripts, tflm_dirs):
    ...
    logging.info(f"Create two dirs: {' '.join(tflm_dirs)} successfully...")
...
if __name__ == "__main__":
    ...
    tflm_dirs = ["Middlewares", "TFLite"]

    # 2. prepare tmp output
    _ = pre_sconscript(stm_out, scons_path, tflm_dirs)
    print("u a right...")
